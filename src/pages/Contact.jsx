...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: [settings.company_email || 'info@hopolsinarjaya.co.id'],
      link: `mailto:${settings.company_email || 'info@hopolsinarjaya.co.id'}`
    },
    {
      icon: Clock,
      title: 'Jam Kerja',
  ...
  return (
    <>
      <SEO 
        title="Hubungi PT. Hopol Sinar Jaya"
        description="Hubungi kami untuk konsultasi jasa pengaspalan, pengecoran beton, atau informasi proyek konstruksi. Tim profesional siap membantu kebutuhan Anda."
        keywords="kontak hopol sinar jaya, alamat jasa pengaspalan, telepon kontraktor jalan, email jasa konstruksi, konsultasi pengaspalan"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p 
              ...
              data-aos-delay="200"
            >
              Tim profesional kami siap membantu Anda menemukan solusi konstruksi 
              yang tepat untuk kebutuhan pengaspalan dan pengecoran proyek Anda.
            </p>
          </div>
        </div>
      </section>
