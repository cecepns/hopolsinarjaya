              ...
              <div className="bg-white rounded-lg shadow-md p-6 mb-8" data-aos="fade-up">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center justify-center w-full bg-red-600 text-white py-3 rounded-lg hover:bg-red-700 transition-colors"
                  >
                  ...
                  <a
                    href="mailto:info@hopolsinarjaya.co.id"
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span>info@hopolsinarjaya.co.id</span>
                    </div>
                    <div className="flex items-center text-gray-600">
