  ...
  const fetchSettings = async () => {
    try {
      ...
      setSettings({
        ...
        company_about: settingsData.company_about || 'Perusahaan penyedia jasa konstruksi dengan berpengalaman. Melayani pengaspalan jalan, pengecoran beton, perbaikan dak & talang dengan kualitas terjamin.'
      });
    } catch (error) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/about" className="text-gray-400 hover:text-red-400 transition-colors">Tentang Kami</Link></li>
              <li><Link to="/services" className="text-gray-400 hover:text-red-400 transition-colors">Layanan</Link></li>
              <li><Link to="/contact" className="text-gray-400 hover:text-red-400 transition-colors">Kontak</Link></li>
            </ul>
          </div>
          ...
          {settings.company_working_hours && (
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start space-x-3">
                  <Clock size={18} className="text-red-400 mt-1" />
